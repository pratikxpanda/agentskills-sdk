...
`vision=True` and bundled images come back as native `Content(type="data")`
carrying a data URI instead:
...
ask a model whether it can see. You know which model your tools are bound to;
