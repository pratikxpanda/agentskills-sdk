...
- [ ] A tag of an unexpected shape fails loudly instead of publishing anywhere
- [ ] `workflow_dispatch` validates and builds without uploading
- [ ] Pre-release tags publish to PyPI
- [ ] `DEVELOPMENT.md` documents the pending-publisher uniqueness limit
