...
## Now — v0.4 "Developer Experience"

Make authoring and validating skills a first-class workflow, and make third-party providers
provably correct. Specifications: [docs/issues/v0.4.md](./issues/v0.4.md).
